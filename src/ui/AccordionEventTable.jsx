  ...
  border: ${({ status, isActive }) => {
    if (isActive) {
      return status === "Completed"
        ...
        : ".1rem solid var(--color-purple-500)"; // Red if completed, blue otherwise
    }
    return status === "Completed"
      ? ".1rem solid var(--color-green-400)" // Green border if completed and not active
      : ".1rem solid var(--color-blue-100)"; // Blue border if not completed and not active
  }};
  border-radius: 2rem;
